            ...
            <table>
                    ...
                    <?php
                        ...
                        foreach ($_SESSION['UsuariosInativos'] as $item) {
                            ...
                            <td>'.($item['comprovante'] != ""? "<a href='comprovantes/".$item['comprovante'].".pdf'>Baixar</a>" : "Não informado").'</td>
                            <td><a href="/detalhesUserId/'.$item['matricula'].'">Detalhes</a> | <a href="aprovarUser/'.$item['matricula'].'">Aprovar</a></td>
                            </tr>';
                        }
                    ?>
            </table>    
