...
<?php $this->section('content'); ?>
    ...
    <div>
        <p><a href="/" class="header-sair">Voltar</a></p>
        <form action='<?=base_url() . '/register' ?>' method='POST' class="formulario" enctype="multipart/form-data">
            <div class="formulario-corpo">
                ...
                <div class="formulario-input">
                    <label for="file">Comprovante de vínculo com a Unilab (ex. comprovante de matrícula,<br> carteira funcional, termo de posse)</label>
